...
Disposable output overlay for [`arran4/goreleaser-gentoo-smoke`](https://github.com/arran4/goreleaser-gentoo-smoke).
...
emerge --oneshot app-eselect/eselect-repository app-editors/vim
