...
SRC_URI="
  arm64? ( https://github.com/arran4/goreleaser-gentoo-smoke/releases/download/v0.0.25/goreleaser-gentoo-smoke_0.0.25_linux_arm64.tar.gz -> goreleaser-gentoo-smoke_0.0.25_linux_arm64.tar.gz )
  amd64? ( https://github.com/arran4/goreleaser-gentoo-smoke/releases/download/v0.0.25/goreleaser-gentoo-smoke_0.0.25_linux_amd64.tar.gz -> goreleaser-gentoo-smoke_0.0.25_linux_amd64.tar.gz )
"
